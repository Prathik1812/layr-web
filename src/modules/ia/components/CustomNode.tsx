...
const CustomNode = ({ id, data, selected }: NodeProps) => {
    ...
    const { updateIANode } = useLayrStore();
        ...
        >
            ...
            {isEditing ? (
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    {typeof (data as any)?.subLabel === 'string' && !isEditing && (
                        <span className="text-[10px] text-gray-500 uppercase tracking-[0.2em] mt-2 font-mono">{String((data as any).subLabel)}</span>
                    )}
                </div>
            )}
