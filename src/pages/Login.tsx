            ...
            >
                ...
                <div className="p-8 md:p-12 relative overflow-hidden">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-4xl font-bold uppercase tracking-tighter mb-2">Identify</h1>
                        <p className="text-xs text-gray-500 font-mono tracking-wider">Please authenticate to access the network.</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            ...
                            <span className="z-10 tracking-widest">Sign In with Google</span>
